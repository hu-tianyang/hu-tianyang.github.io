...
- **Top-down**: analyzing state-of-the-art methods and proposing theory-inspired new algorithms.

In this group, we prioritize **scientific value**. We believe that achieving a **concrete understanding** takes precedence over tuning black-box models for incremental improvements. Ideally, a project should offer both high scientific insight and high potential for practical impact.
Coming from a statistics background, I believe statistics — along with other theoretical disciplines — has much to contribute to this effort.
